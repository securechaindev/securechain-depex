...
class OperationService:
    def __init__(self, db: DatabaseManager):
        self.operation_result_collection = db.get_operation_result_collection()

    async def replace_operation_result(self, operation_result_id: str, result: dict[str, Any]) -> None:
        await self.operation_result_collection.replace_one(
    ...
    async def read_operation_result(self, operation_result_id: str) -> dict[str, Any]:
        return await self.operation_result_collection.find_one({"operation_result_id": operation_result_id})
