...
const MaximiseImpactOperation = (props) => {
  ...
  const on_button_maximise_operation = () => {
    set_max_level_error('')
    set_limit_error('')
    ...
    fetch('http://localhost:8000/operation/file/maximize_impact', {
      method: 'POST',
      headers: {
  ...
  return (
    <div className='flex-col flex'>
      ...
      <input
        ...
        onKeyDown={(e) => {
          if (e.key === 'Enter') on_button_maximise_operation()
        }}
      ...
      <input
        ...
        type='button'
        onClick={on_button_maximise_operation}
        value={'Apply'}
      />
    </div>
  )
